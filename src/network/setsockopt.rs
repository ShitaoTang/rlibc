...
pub extern "C" fn setsockopt(fd: c_int, level: c_int, optname: c_int, optval: *const c_void, optlen: socklen_t) -> c_int
{
    ...
    let mut r = socketcall(SYS_setsockopt as c_int, fd as c_long, level as c_long, optname as c_long, optval as c_long, optlen as c_long, 0) as c_int;
    ...
    libc::SOL_SOCKET => {
        ...
        libc::SO_RCVTIMEO | libc::SO_SNDTIMEO => {
            ...
            if optlen < size_of::<libc::timeval>() as socklen_t { return __syscall_ret(-EINVAL as u64) as c_int; }
        ...
        libc::SO_TIMESTAMP | libc::SO_TIMESTAMPNS => {
            ...
            r = socketcall(SYS_setsockopt as c_int, fd as c_long, level as c_long, optname as c_long, optval as c_long, optlen as c_long, 0) as c_int;
            return __syscall_ret(r as u64) as c_int;
        }
        _ => {}
        }
